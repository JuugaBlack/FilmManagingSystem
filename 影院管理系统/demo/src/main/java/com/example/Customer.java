...
public class Customer extends User{
    ...
    static String customerfile = "顾客V1.4.xlsx";
    protected static List<Customer> customers = FileManager.readCustomersFromExcel(customerfile);
    ...
    public boolean register(){
        ...
        if (hashedPassword == null) {
            System.out.println("密码哈希失败，请稍后再试！");
            return false;
        }
        ...
        FileManager.writeUsersToFile(User.userfile, customers);
        FileManager.writeCustomersToExcel(customerfile, customers);
